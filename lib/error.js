...
const parsecExecName = process.platform === 'darwin' ? 'parsecd' : 'parsecd.exe'

const errorToMessageArr = [
    [error.SUCCESS,                 "success"],
    [error.PARSECD_NOT_IN_DEFAULT,  `Parsecd not in default location run "parsec-switcher setLoc <${parsecExecName} Location>"`],
